...
import YoutubeSolidIcon from '@/assets/icons/youtube-solid.svg?react';
import YoutubeStrokeIcon from '@/assets/icons/youtube-stroke.svg?react';
...
function TabBar() {
  ...
  return (
    <div className="bg-base-300 flex h-[50px]">
      ...
      <Link to={`/reels`} className="flex flex-1 items-center justify-center">
        {pathname === '/reels' ? <YoutubeSolidIcon /> : <YoutubeStrokeIcon />}
      </Link>
